...
const translations = {
  ar: {
    ...
    homeHeroDescription: 'انضم إلى آلاف المقاومين حول العالم في المساعدة والخير والبناء ونشر الحقيقة و القصاء على من يسعى للسيطرة على البشرية. معاً نستطيع تغيير العالم.',
